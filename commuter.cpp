...
void Commuter::openfile(ifstream &infile, string &fname)
{
    using namespace std;
    cout << "Hello, please choose a flight to book seats on from the following:"
         << "fa2321.fdf (it is a commuter flight)"; 
...
void Commuter::save_flight_data(const vector<string> &rows,const string &fname)
{
    using namespace std;
...
unsigned int Commuter::get_flight_data(ifstream &fdin, vector<string> &vec)
{
    using namespace std;
    string row;
...
void Commuter::read_flight_data(ifstream &fltdata,string &fname, vector<string> &rows,unsigned int &rowct)
{
...
void Commuter::displayrow(const string &rw)
{
    int count = 1;
...
void Commuter::special_seats(const string &rw)
{
    int count = 0;
    for (unsigned int i = 0U; i < rw.length(); ++i)
    {
...
void Commuter::show_special_seats(vector<string> &seats)
{
...
void Commuter::showseating(const vector<string> &seats)
{
    using namespace std;
    for (unsigned int i = 0U; i < seats.size(); ++i)
    {
...
void Commuter::change_first(vector<string> &seats, string name)
{
ifstream ifile;
ofstream ofile;
    int num;
...
void Commuter::change_econ(vector<string> &seats, string name)
{
ifstream ifile;
ofstream ofile;
    int num;
...
bool Commuter::book_seat(vector<string> &rows, int rnum, char seat)
{
    int seatcount;
...
bool Commuter::remove_seat(vector<string> &rows, int &rnum, int &seat)
{
    int seatcount;
    if ((seat == 1) || (seat == 2) || (seat == 3))
        seatcount = seat;
...
void Commuter::book_flight(vector<string> &rows)
{
    using namespace std;
